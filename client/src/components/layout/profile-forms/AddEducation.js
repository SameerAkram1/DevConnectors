...
const AddEducation = ({ addEducation }) => {
    ...
    return (
        <Fragment>
            ...
            <p class="lead">
                <i class="fas fa-code-branch"></i> Add any school/bootcam you attended
            </p>
            <small>required field</small>
            <form class="form" onSubmit={onSubmit}>
                <div class="form-group">
                    <input type="text" placeholder="* School or bootcamp" name="school" value={school} required onChange={onChange} />
                </div>
                <div class="form-group">
                    <input type="text" placeholder="* Degree" name="degree" value={degree} onChange={onChange} required />
                </div>
                <div class="form-group">
                    <input type="text" placeholder="Field of study" name="fieldofstudy" value={fieldofstudy} required onChange={onChange} />
                </div>
                <div class="form-group">
                    <h4>From Date</h4>
